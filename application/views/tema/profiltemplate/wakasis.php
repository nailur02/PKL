<?php
$tempat=field_value('waka_siswa','user_id',user_info('user_id'),'tempat');
$tgl=field_value('waka_siswa','user_id',user_info('user_id'),'tgl_lahir');
$jk=field_value('waka_siswa','user_id',user_info('user_id'),'jenkel');
echo validation_errors();
echo form_open(base_url('profil/updatemanajemen'),array('class'=>'form-horizontal'));
?>
<input type="hidden" name="table" value="waka_siswa"/>
...
<div class="form-group">
	...
	<div class="col-md-6">
		...
		<small class="text-warning">Masukkan password baru jika ingin mengubahnya</small>
	</div>
</div>
<div class="form-group">
