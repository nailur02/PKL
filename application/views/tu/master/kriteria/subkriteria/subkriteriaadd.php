...
echo form_open(base_url(akses().'/master/kriteria/subkriteriaadd').$link,array('class'=>'form-horizontal'));
?>

<h3 class="box-title margin text-center">Tambah Data Parameter</h3>
