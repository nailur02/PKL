...
<div>
<a href="<?=base_url(akses().'/master/kriteria');?>" class="btn btn-default btn-md">Kembali</a>
</div>
...
<thead>
	<th colspan="<?=$jumlah+1;?>" class="text-center">Matrik Perbandingan Berpasangan Ku</th>
</thead>
<thead>
	<th>Kriteria</th>
	<?php
