...
?>
<a href="<?=base_url('laporan/penerimabeasiswa');?>?id=<?=$beasiswaid;?>" target="_blank" class="btn btn-success btn-md hidden-print"><i class="fa fa-print"></i> Cetak</a>
<a href="javascript:;" onclick="proseshitung();" class="btn btn-warning"><i class="fa fa-repeat"></i> Ulangi Proses Hitung</a>
<table class="table table-bordered table-striped dataTable no-footer" style="margin-top:15px;">
