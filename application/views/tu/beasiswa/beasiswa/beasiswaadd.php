...
echo form_open(base_url(akses().'/beasiswa/beasiswa/add'),array('class'=>'form-horizontal'));
?>
...
<div class="form-group">
	...
	<div class="col-md-6">
		<button type="submit" class="btn btn-success"><i class="fa fa-ok"></i> Tambah</button>
