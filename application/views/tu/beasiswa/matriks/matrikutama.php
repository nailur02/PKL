...
$("#formentri").submit(function(e){
	...
	$.ajax({
		type:'post',
		dataType:'json',
		url:"<?=base_url(akses());?>/beasiswa/kriteria/updateutama",
		data:$(this).serialize(),
		error:function(){
...
function showsubkriteria()
{
	$.ajax({
			type:'get',
			dataType:'html',
			url:"<?=base_url(akses().'/beasiswa/kriteria/getsubcontainer');?>",
...
<thead>
	<h4 style="text-align:center;font-size:16px;font-weight:bold;">Matrik Perbandingan Berpasangan</h4>
</thead>
		...
		for($i=1;$i<=$jumlah;$i++)
		{
			...
			if($noSub==$noUtama)
			{
				...
				{									
					...
					for($x=1;$x<=9;$x++)
					{
						$nilai=ambil_nilai_kriteria($beasiswaid,$k2,$xxx);
						$sl='';
						if($nilai==$x)
						{
...
<div class="pull-left">
	<a href="javascript:;" onclick="hitung();" class="btn btn-primary"><i class="fa fa-plus"></i> Hitung</a> 
	<a href="javascript:;" onclick="showmatrix();" class="btn btn-info"><i class="fa fa-eye"></i> Lihat Matriks</a>	
	<a href="javascript:;" onclick="showsubkriteria();" class="btn btn-info"><i class="fa fa-eye"></i> Lihat Sub Kriteria</a>	
</div>
<div class="pull-right">
	<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> Simpan Kriteria</button>
</div>
<?php
echo form_close();
?>
...
<table class="table table-bordered table-striped dataTable no-footer">
<thead>
	<h4 style="text-align:center;font-size:16px;font-weight:bold;">Matrik Nilai Kriteria</h4>
</thead>
<thead style="background:#50a3a2;color:#fff;">
	<th>Kriteria</th>
	<?php
...
<table class="table table-bordered table-striped dataTable no-footer">
<thead>
	<h4 style="text-align:center;font-size:16px;font-weight:bold;">Matrik Penjumlahan Tiap Baris</h4>
</thead>
<thead style="background:#50a3a2;color:#fff;">
	<th>Kriteria</th>
	<?php
...
<table class="table table-bordered table-striped dataTable no-footer">
<thead>
<h4 style="text-align:center;font-size:16px;font-weight:bold;">Rasio Konsistensi</h4>
</thead>
<thead style="background:#50a3a2;color:#fff;">
	<th>Kriteria</th>	
...
<table class="table table-bordered table-striped dataTable no-footer">
<thead>
<h4 style="text-align:center;font-size:16px;font-weight:bold;">Hasil Perhitungan</h4>
</thead>
<thead style="background:#50a3a2;color:#fff;">
	<th>Keterangan</th>
	<th>Nilai</th>
